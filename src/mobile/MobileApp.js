...
import MobileMyPage from './MobileMyPage'; // MobileMyPage 컴포넌트 임포트
            ...
            <div>
                ...
                <div className={isMenuOpen ? styles.blurred : ''}>
                    <Routes>
                        ...
                        <Route path="/mypage" element={<MobileMyPage userData={userData} setUserData={setUserData} />} /> {/* MobileMyPage 사용 */}
                    </Routes>
                </div>

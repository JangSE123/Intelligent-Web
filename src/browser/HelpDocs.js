          ...
          {currentSection === "github" && (
            <section>
              ...
              <div className={`${styles.contentItem} ${styles.sectionContent}`}>
                ...
                <p>
                  <strong>Git</strong>은 분산 버전 관리 시스템으로, 로컬
                  저장소에서 작업하고 변경 사항을 추적할 수 있습니다.
                </p>
              </div>
              <div className={`${styles.contentItem} ${styles.sectionContent}`}>
                <svg
                ...
                <p>
                  <strong>GitHub</strong>는 Git 저장소를 호스팅하는 클라우드
                  기반 플랫폼으로, 원격 저장소에 저장하고 다른 개발자들과 협업할
                  수 있습니다.
                </p>
              </div>
              <div className={`${styles.contentItem} ${styles.sectionContent}`}>
                ...
                <ul>
                  <li>
                    <strong>분산 버전 관리 시스템</strong>: Git은 소스 코드를
                    관리하고 변경 사항을 추적할 수 있는 분산 버전 관리
                    시스템입니다. 로컬 저장소에서 작업을 하고 변경 사항을
                    커밋(commit)하며, 필요할 때 원격 저장소에 푸시(push)하여
                    동기화할 수 있습니다.
                  </li>
                  <li>
                    <strong>오프라인 작업 가능</strong>: Git은 로컬 저장소에서
                    오프라인으로 작업할 수 있으며, 인터넷에 연결되었을 때 원격
                    저장소와 동기화할 수 있습니다.
                  </li>
                </ul>
                <p>
